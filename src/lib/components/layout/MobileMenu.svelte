...
{#if $mobileMenuOpen}
	...
	<button
		...
		class="fixed inset-0 bg-black/80 backdrop-blur-sm z-40 lg:hidden cursor-default"
	...
	<div
		...
		class="fixed top-16 right-0 bottom-0 w-80 max-w-[85vw] bg-bg-secondary border-l border-brand-primary/20 z-40 lg:hidden overflow-y-auto"
	>
		<div class="p-6 space-y-6">
			...
			<!-- Social Links -->
			<div class="pt-6 border-t border-bg-accent">
